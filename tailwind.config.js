	...
	theme: {
		...
		extend: {
			colors: {
				...
				"classmate-hover-green-4": "var(--classmate-hover-green-4)",
				"classmate-hover-tan-1": "var(--classmate-hover-tan-1)",
				"classmate-hover-tan-2": "var(--classmate-hover-tan-2)",
				"classmate-hover-gold-1": "var(--classmate-hover-gold-1)",
			},
		},
	},
	plugins: [],

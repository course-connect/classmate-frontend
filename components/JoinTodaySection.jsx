		...
		<div className='section-padding bg-classmate-tan-1'>
			<div className='xl:gap-22 flex flex-col  items-center  justify-center px-10 py-12 sm:flex-row sm:gap-12 xl:py-16 2xl:px-16 3xl:gap-28'>
				...
				<div className='mt-8 flex flex-col items-center justify-center gap-2 sm:mt-0 lg:flex-row xl:gap-8'>
					<button className='btn btn-hover btn-large bg-classmate-green-2 text-classmate-tan-1'>
						Join Today
					</button>
					<button className='btn btn-outline btn-large btn-hover border-classmate-green-2 text-classmate-green-2'>
						Contact Us
					</button>
				</div>
			</div>

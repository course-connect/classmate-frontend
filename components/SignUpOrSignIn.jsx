...
export default function SignUpOrSignIn({ form, heading, subheading, variant }) {
	return (
		<div className='section-padding flex justify-center bg-classmate-tan-1 py-[60px]'>
			<div className='flex w-full flex-col items-center justify-center rounded-2xl bg-classmate-tan-2 px-10 py-12 shadow-xl xs:max-w-[420px] sm:max-w-[520px] sm:p-[68px]'>
				<HomepageHeading headingStyles='xl:text-[40px]' lineStyles='xl:top-14'>
					{heading}
				</HomepageHeading>
